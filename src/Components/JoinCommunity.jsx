  ...
  return (
    <section className="w-full my-10 md:my-16 bg-[#F1F7FF] overflow-hidden">
      <div className="w-full max-w-[1600px] mx-auto px-6 py-8 md:py-24 flex items-center justify-between gap-10 flex-col md:flex-row">
        <img src="community.jpg" alt="image" className="w-full md:w-[550px] rounded-3xl" />

        <div className="w-full md:w-[45%]" id="contactfornow">
          ...
          <button className="py-3 px-6 bg-brandColor rounded-3xl text-[#fff]">
            Join Us
          </button>
        </div>
      </div>
